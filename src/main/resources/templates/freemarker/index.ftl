...
<main role="main">
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img class="rounded-circle" src="../../bootstrap-4.3.1/assets/img/icons/home console.jpg" alt="Generic placeholder image" width="140" height="140">
                <h2>Home consoles</h2>
            ...
            <div class="col-lg-4">
                <img class="rounded-circle" src="../../bootstrap-4.3.1/assets/img/icons/handheld icon.jpg" alt="Generic placeholder image" width="140" height="140">
            ...
            <div class="col-lg-4">
                <img class="rounded-circle" src="../../bootstrap-4.3.1/assets/img/icons/videogame icon.jpg" alt="Generic placeholder image" width="140" height="140">
                <h2>Videogames</h2>
