...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Album of my top 9 best handheld consoles</h1>
            <p class="lead text-muted">In this gallery, i'm going to show pictures of the top 9 best handheld consoles, also i'm going to put a short description of each one of these.</p>
            <p>
                <a href="/showHomeConsole" class="btn btn-primary my-2">Go to the home console page</a>
                <a href="/showVideogame" class="btn btn-secondary my-2">Go to the videogame page</a>
            </p>
        </div>
    </section>
